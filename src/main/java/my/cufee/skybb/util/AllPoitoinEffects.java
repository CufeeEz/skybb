...
public class AllPoitoinEffects {
    ...
    public static List<PotionEffectType> givePoitionEffects(){
        ...
        potionEffects.add(PotionEffectType.DOLPHINS_GRACE);
        ...
        potionEffects.add(PotionEffectType.HEAL);
        potionEffects.add(PotionEffectType.HEALTH_BOOST);
        ...
        potionEffects.add(PotionEffectType.LUCK);
